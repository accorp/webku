		...
		<meta name="description" content="<?php head_meta_desc_maxx(); ?>" />
        ...
        <meta property="og:description" content="<?php head_meta_desc_maxx(); ?>" />
		<?php 
		    global $wp;
        ...
        <meta name="twitter:description" content="<?php head_meta_desc_maxx(); ?>" />
		<?php 
		    if ( is_singular() ) {  
			    if (have_posts()):
				    while (have_posts()): the_post(); 
						...
						if (has_post_thumbnail()) { 
							...
							if ( get_theme_mod('maxx_default_thumbnail') != "" ) {
								echo '<meta property="og:image" content="'. esc_attr( get_theme_mod('maxx_default_thumbnail_share') ).'" />';
								echo '<meta property="og:image:secure_url" content="'. esc_attr( get_theme_mod('maxx_default_thumbnail_share') ).'" />';
								echo '<meta name="twitter:image" content="'. esc_attr( get_theme_mod('maxx_default_thumbnail_share') ).'" />';
							} else {
