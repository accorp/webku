...
function web_custom_styles($custom) {
	$body_font = esc_html(get_theme_mod('maxx_body_font'));
	if ( $body_font ) {
		$font_pieces = explode(":", $body_font);
		$custom .= "body, button, input, select, textarea { font-family: {$font_pieces[0]} !important; }"."\n";
	}
	$menu_font = esc_html(get_theme_mod('maxx_menu_font'));
	if ( $menu_font ) {
		$font_pieces = explode(":", $menu_font);
		$custom .= ".maxx_flat_menu { font-family: {$font_pieces[0]} !important; }"."\n";
	}
	$headings_font = esc_html(get_theme_mod('maxx_heading_font'));
	if ( $headings_font ) {
		$font_pieces = explode(":", $headings_font);
		$custom .= "h1, h2, h3, h4, h5, h6, .stand_slide_title, .excerpt__title, .double_block_half_title, .maxxtwo_block_title, .double_block_first_title, double_block_after_title, .singleslide_title, .late_list_title, .number_title, .trending_title, area_secondary a { font-family: {$font_pieces[0]} !important; }"."\n";
	}
    $loop_font = esc_html(get_theme_mod('maxx_loop_font'));
	if ( $loop_font ) {
		$font_pieces = explode(":", $loop_font);
		$custom .= ".classic_title, .rel_title { font-family: {$font_pieces[0]} !important; }"."\n";
	}
	wp_add_inline_style( 'web-css', $custom );

}

add_action( 'wp_footer', 'web_custom_styles' );
...
function web_scripts() {
	...
	$body_font = esc_html(get_theme_mod('maxx_body_font'));
	if( $body_font ) {
		wp_enqueue_style( 'web-body-fonts', 'https://fonts.googleapis.com/css?family='. $body_font . '&display=swap' );
	} 
	$menu_font = esc_html(get_theme_mod('maxx_menu_font'));
	if( $menu_font ) {
		wp_enqueue_style( 'web-menu-fonts', 'https://fonts.googleapis.com/css?family='. $menu_font . '&display=swap' );
	} 
	$headings_font = esc_html(get_theme_mod('maxx_heading_font'));
	if( $headings_font ) {
		wp_enqueue_style( 'web-headings-fonts', 'https://fonts.googleapis.com/css?family='. $headings_font . '&display=swap' );
	} 
	$loop_font = esc_html(get_theme_mod('maxx_loop_font'));
	if( $loop_font ) {
		wp_enqueue_style( 'web-loop-fonts', 'https://fonts.googleapis.com/css?family='. $loop_font . '&display=swap' );
	} 
	
}
add_action( 'wp_footer', 'web_scripts' );


function head_customizer_style() {
	echo '<style type="text/css">'; 
	$body_font = get_theme_mod('maxx_body_font');
	if ( $body_font ) {
		$font_pieces = explode(":", $body_font);
		echo "body, button, input, select, textarea { font-family: {$font_pieces[0]} !important; }"."\n";
	}
	$menu_font = get_theme_mod('maxx_menu_font');
	if ( $menu_font ) {
		$font_pieces = explode(":", $menu_font);
		echo ".maxx_flat_menu { font-family: {$font_pieces[0]} !important; }"."\n";
	}
	$headings_font = esc_html(get_theme_mod('maxx_heading_font'));
	if ( $headings_font ) {
		$font_pieces = explode(":", $headings_font);
		echo "h1, h2, h3, h4, h5, h6, .stand_slide_title, .excerpt__title, .double_block_half_title, .maxxtwo_block_title, .double_block_first_title, double_block_after_title, .singleslide_title, .late_list_title, .number_title, .trending_title, area_secondary a { font-family: {$font_pieces[0]} !important; }"."\n";
	}
	$loop_font = esc_html(get_theme_mod('maxx_loop_font'));
	if ( $loop_font ) {
		$font_pieces = explode(":", $loop_font);
		echo ".classic_title, .rel_title { font-family: {$font_pieces[0]} !important; }"."\n";
	}
	?>
	
	body, button, input, select, textarea {
		font-size: <?php echo get_theme_mod('maxx_body_fontsize', 14); ?>px; 
	}
	.maxx_container,
	.maxx_running,
	.area_content,
	...
	.share,
	.maxxfooter { 
    	max-width: <?php echo get_theme_mod('global_site_width', 1000); ?>px !important; 
	}
	h1, h2, h3, h4, h5, h6 {
		font-weight: <?php echo get_theme_mod('maxx_heading_fontweight', 700); ?>; 
	}
	#maxxmenu {
		font-size: <?php echo get_theme_mod('maxx_menu_fontsize', 14); ?>px; 
		font-weight: <?php echo get_theme_mod('maxx_menu_fontweight', 700); ?>; 
	}
	.classic_title {
		font-weight: <?php if ( get_theme_mod('maxx_loop_fontweight') != "" ) {
	    	echo esc_html( get_theme_mod( 'maxx_loop_fontweight') ); 
		} else {
			echo 700;
		} ?>;
	}
	...
	.classic_title {
	    font-weight: <?php echo get_theme_mod('maxx_loop_font', 700); ?>; 
    }
...
function web_sanitize_fonts( $input ) {
	$valid = array(
            ...
            'Abel:400' => 'Abel',
            'Abhaya Libre:400,800' => 'Abhaya Libre',
            'Aboreto:400' => 'Aboreto',
            ...
            'Actor:400' => 'Actor',
            'Adamina:400' => 'Adamina',
            'Advent Pro:100,200,300,400' => 'Advent Pro',
            'Aguafina Script:400' => 'Aguafina Script',
            'Akaya Kanadaka:400' => 'Akaya Kanadaka',
            'Akaya Telivigala:400' => 'Akaya Telivigala',
            'Akronim:400' => 'Akronim',
            'Akshar:300,400' => 'Akshar',
            'Aladin:400' => 'Aladin',
            'Alata:400' => 'Alata',
            'Alatsi:400' => 'Alatsi',
            'Albert Sans:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Albert Sans',
            'Aldrich:400' => 'Aldrich',
            'Alef:400,700' => 'Alef',
            'Alegreya:400,800,900,400italic,500italic,600italic,700italic,800italic,900italic' => 'Alegreya',
            ...
            'Alumni Sans:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Alumni Sans',
            ...
            'Amita:400,700' => 'Amita',
            'Anaheim:400' => 'Anaheim',
            'Andada Pro:400,800,400italic,500italic,600italic,700italic,800italic' => 'Andada Pro',
            'Andika:400,400italic,700,700italic' => 'Andika',
            'Anek Bangla:100,200,300,400,800' => 'Anek Bangla',
            'Anek Devanagari:100,200,300,400,800' => 'Anek Devanagari',
            'Anek Gujarati:100,200,300,400,800' => 'Anek Gujarati',
            'Anek Gurmukhi:100,200,300,400,800' => 'Anek Gurmukhi',
            'Anek Kannada:100,200,300,400,800' => 'Anek Kannada',
            'Anek Latin:100,200,300,400,800' => 'Anek Latin',
            'Anek Malayalam:100,200,300,400,800' => 'Anek Malayalam',
            'Anek Odia:100,200,300,400,800' => 'Anek Odia',
            'Anek Tamil:100,200,300,400,800' => 'Anek Tamil',
            'Anek Telugu:100,200,300,400,800' => 'Anek Telugu',
            'Angkor:400' => 'Angkor',
            ...
            'Anton:400' => 'Anton',
            'Antonio:100,200,300,400' => 'Antonio',
            'Anybody:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Anybody',
            'Arapey:400,400italic' => 'Arapey',
            'Arbutus:400' => 'Arbutus',
            'Arbutus Slab:400' => 'Arbutus Slab',
            'Architects Daughter:400' => 'Architects Daughter',
            'Archivo:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Archivo',
            'Archivo Black:400' => 'Archivo Black',
            'Archivo Narrow:400,400italic,500italic,600italic,700italic' => 'Archivo Narrow',
            'Are You Serious:400' => 'Are You Serious',
            'Aref Ruqaa:400,700' => 'Aref Ruqaa',
            'Arima:100,200,300,400' => 'Arima',
            'Arima Madurai:100,200,300,400,500,700,800,900' => 'Arima Madurai',
            'Arimo:400,400italic,500italic,600italic,700italic' => 'Arimo',
            ...
            'Arya:400,700' => 'Arya',
            'Asap:400,400italic,500italic,600italic,700italic' => 'Asap',
            'Asap Condensed:400,400italic,500,500italic,600,600italic,700,700italic' => 'Asap Condensed',
            'Asar:400' => 'Asar',
            'Asset:400' => 'Asset',
            'Assistant:200,300,400,800' => 'Assistant',
            'Astloch:400,700' => 'Astloch',
            'Asul:400,700' => 'Asul',
            'Athiti:200,300,400' => 'Athiti',
            ...
            'Azeret Mono:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Azeret Mono',
            ...
            'Ballet:400' => 'Ballet',
            'Baloo 2:400,800' => 'Baloo 2',
            'Baloo Bhai 2:400,800' => 'Baloo Bhai 2',
            'Baloo Bhaijaan 2:400,800' => 'Baloo Bhaijaan 2',
            'Baloo Bhaina 2:400,800' => 'Baloo Bhaina 2',
            'Baloo Chettan 2:400,800' => 'Baloo Chettan 2',
            'Baloo Da 2:400,800' => 'Baloo Da 2',
            'Baloo Paaji 2:400,800' => 'Baloo Paaji 2',
            'Baloo Tamma 2:400,800' => 'Baloo Tamma 2',
            'Baloo Tammudu 2:400,800' => 'Baloo Tammudu 2',
            'Baloo Thambi 2:400,800' => 'Baloo Thambi 2',
            ...
            'Besley:400,800,900,400italic,500italic,600italic,700italic,800italic,900italic' => 'Besley',
            'Beth Ellen:400' => 'Beth Ellen',
            'Bevan:400,400italic' => 'Bevan',
            'BhuTuka Expanded One:400' => 'BhuTuka Expanded One',
            'Big Shoulders Display:100,200,300,400,800,900' => 'Big Shoulders Display',
            'Big Shoulders Inline Display:100,200,300,400,800,900' => 'Big Shoulders Inline Display',
            'Big Shoulders Inline Text:100,200,300,400,800,900' => 'Big Shoulders Inline Text',
            'Big Shoulders Stencil Display:100,200,300,400,800,900' => 'Big Shoulders Stencil Display',
            'Big Shoulders Stencil Text:100,200,300,400,800,900' => 'Big Shoulders Stencil Text',
            'Big Shoulders Text:100,200,300,400,800,900' => 'Big Shoulders Text',
            ...
            'Bitter:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Bitter',
            ...
            'Bodoni Moda:400,800,900,400italic,500italic,600italic,700italic,800italic,900italic' => 'Bodoni Moda',
            'Bokor:400' => 'Bokor',
            ...
            'Brygada 1918:400,400italic,500italic,600italic,700italic' => 'Brygada 1918',
            ...
            'Cabin:400,400italic,500italic,600italic,700italic' => 'Cabin',
            ...
            'Cairo:200,300,400,800,900' => 'Cairo',
            ...
            'Catamaran:100,200,300,400,800,900' => 'Catamaran',
            ...
            'Commissioner:100,200,300,400,800,900' => 'Commissioner',
            ...
            'Cormorant:300,400,300italic,400italic,500italic,600italic,700italic' => 'Cormorant',
            ...
            'Cormorant SC:300,400' => 'Cormorant SC',
            'Cormorant Unicase:300,400' => 'Cormorant Unicase',
            'Cormorant Upright:300,400' => 'Cormorant Upright',
            ...
            'Crimson Pro:200,300,400,800,900,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Crimson Pro',
            'Crimson Text:400,400italic,600,600italic,700,700italic' => 'Crimson Text',
            'Croissant One:400' => 'Croissant One',
            'Crushed:400' => 'Crushed',
            'Cuprum:400,400italic,500italic,600italic,700italic' => 'Cuprum',
            ...
            'Dangrek:400' => 'Dangrek',
            'Darker Grotesque:300,400,800,900' => 'Darker Grotesque',
            ...
            'Dorsa:400' => 'Dorsa',
            'Dosis:200,300,400,800' => 'Dosis',
            'DotGothic16:400' => 'DotGothic16',
            'Dr Sugiyama:400' => 'Dr Sugiyama',
            'Duru Sans:400' => 'Duru Sans',
            'DynaPuff:400' => 'DynaPuff',
            'Dynalight:400' => 'Dynalight',
            'EB Garamond:400,800,400italic,500italic,600italic,700italic,800italic' => 'EB Garamond',
            'Eagle Lake:400' => 'Eagle Lake',
            'East Sea Dokdo:400' => 'East Sea Dokdo',
            'Eater:400' => 'Eater',
            'Economica:400,400italic,700,700italic' => 'Economica',
            'Eczar:400,800' => 'Eczar',
            'Edu NSW ACT Foundation:400' => 'Edu NSW ACT Foundation',
            'Edu QLD Beginner:400' => 'Edu QLD Beginner',
            'Edu SA Beginner:400' => 'Edu SA Beginner',
            'Edu TAS Beginner:400' => 'Edu TAS Beginner',
            'Edu VIC WA NT Beginner:400' => 'Edu VIC WA NT Beginner',
            'El Messiri:400' => 'El Messiri',
            ...
            'Encode Sans:100,200,300,400,800,900' => 'Encode Sans',
            'Encode Sans Condensed:100,200,300,400,800,900' => 'Encode Sans Condensed',
            'Encode Sans Expanded:100,200,300,400,800,900' => 'Encode Sans Expanded',
            'Encode Sans SC:100,200,300,400,800,900' => 'Encode Sans SC',
            'Encode Sans Semi Condensed:100,200,300,400,800,900' => 'Encode Sans Semi Condensed',
            'Encode Sans Semi Expanded:100,200,300,400,800,900' => 'Encode Sans Semi Expanded',
            'Engagement:400' => 'Engagement',
            'Englebert:400' => 'Englebert',
            'Enriqueta:400' => 'Enriqueta',
            'Ephesis:400' => 'Ephesis',
            'Epilogue:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Epilogue',
            'Erica One:400' => 'Erica One',
            'Esteban:400' => 'Esteban',
            'Estonia:400' => 'Estonia',
            'Euphoria Script:400' => 'Euphoria Script',
            'Ewert:400' => 'Ewert',
            'Exo:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Exo',
            'Exo 2:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Exo 2',
            'Expletus Sans:400,400italic,500italic,600italic,700italic' => 'Expletus Sans',
            'Explora:400' => 'Explora',
            'Fahkwang:200,200italic,300,300italic,400,400italic,500,500italic,600,600italic,700,700italic' => 'Fahkwang',
            'Familjen Grotesk:400,400italic,500italic,600italic,700italic' => 'Familjen Grotesk',
            ...
            'Faustina:300,400,800,300italic,400italic,500italic,600italic,700italic,800italic' => 'Faustina',
            'Federant:400' => 'Federant',
            'Federo:400' => 'Federo',
            'Felipa:400' => 'Felipa',
            'Fenix:400' => 'Fenix',
            'Festive:400' => 'Festive',
            'Figtree:300,400,800,900' => 'Figtree',
            'Finger Paint:400' => 'Finger Paint',
            'Finlandica:400,400italic,500italic,600italic,700italic' => 'Finlandica',
            'Fira Code:300,400' => 'Fira Code',
            ...
            'Fraunces:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Fraunces',
            'Freckle Face:400' => 'Freckle Face',
            'Fredericka the Great:400' => 'Fredericka the Great',
            'Fredoka:300,400' => 'Fredoka',
            ...
            'Gantari:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Gantari',
            'Gayathri:100,400,700' => 'Gayathri',
            'Gelasio:400,400italic,500,500italic,600,600italic,700,700italic' => 'Gelasio',
            'Gemunu Libre:200,300,400,800' => 'Gemunu Libre',
            'Genos:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Genos',
            ...
            'Georama:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Georama',
            'Geostar:400' => 'Geostar',
            ...
            'Glory:100,200,300,400,800,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic' => 'Glory',
            'Gluten:100,200,300,400,800,900' => 'Gluten',
            'Goblin One:400' => 'Goblin One',
            'Gochi Hand:400' => 'Gochi Hand',
            'Goldman:400,700' => 'Goldman',
            'Gorditas:400,700' => 'Gorditas',
            'Gothic A1:100,200,300,400,800,900' => 'Gothic A1',
            'Gotu:400' => 'Gotu',
            ...
            'Grandstander:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Grandstander',
            ...
            'Grenze Gotisch:100,200,300,400,800,900' => 'Grenze Gotisch',
            'Grey Qo:400' => 'Grey Qo',
            'Griffy:400' => 'Griffy',
            'Gruppo:400' => 'Gruppo',
            ...
            'Hahmlet:100,200,300,400,800,900' => 'Hahmlet',
            'Halant:300,400' => 'Halant',
            ...
            'Heebo:100,200,300,400,800,900' => 'Heebo',
            'Henny Penny:400' => 'Henny Penny',
            'Hepta Slab:100,200,300,400,800,900' => 'Hepta Slab',
            'Herr Von Muellerhoff:400' => 'Herr Von Muellerhoff',
            'Hi Melody:400' => 'Hi Melody',
            'Hina Mincho:400' => 'Hina Mincho',
            'Hind:300,400' => 'Hind',
            'Hind Guntur:300,400' => 'Hind Guntur',
            'Hind Madurai:300,400' => 'Hind Madurai',
            'Hind Siliguri:300,400' => 'Hind Siliguri',
            'Hind Vadodara:300,400' => 'Hind Vadodara',
            ...
            'IBM Plex Sans Arabic:100,200,300,400' => 'IBM Plex Sans Arabic',
            ...
            'IBM Plex Sans Devanagari:100,200,300,400' => 'IBM Plex Sans Devanagari',
            'IBM Plex Sans Hebrew:100,200,300,400' => 'IBM Plex Sans Hebrew',
            'IBM Plex Sans KR:100,200,300,400' => 'IBM Plex Sans KR',
            'IBM Plex Sans Thai:100,200,300,400' => 'IBM Plex Sans Thai',
            'IBM Plex Sans Thai Looped:100,200,300,400' => 'IBM Plex Sans Thai Looped',
            ...
            'Ibarra Real Nova:400,400italic,500italic,600italic,700italic' => 'Ibarra Real Nova',
            'Iceberg:400' => 'Iceberg',
            'Iceland:400' => 'Iceland',
            'Imbue:100,200,300,400,800,900' => 'Imbue',
            'Imperial Script:400' => 'Imperial Script',
            'Imprima:400' => 'Imprima',
            'Inconsolata:200,300,400,800,900' => 'Inconsolata',
            'Inder:400' => 'Inder',
            'Indie Flower:400' => 'Indie Flower',
            'Ingrid Darling:400' => 'Ingrid Darling',
            'Inika:400,700' => 'Inika',
            'Inknut Antiqua:300,400,800,900' => 'Inknut Antiqua',
            ...
            'Inter:100,200,300,400,800,900' => 'Inter',
            ...
            'Jaldi:400,700' => 'Jaldi',
            'JetBrains Mono:100,200,300,400,800,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic' => 'JetBrains Mono',
            ...
            'Josefin Sans:100,200,300,400,100italic,200italic,300italic,400italic,500italic,600italic,700italic' => 'Josefin Sans',
            'Josefin Slab:100,200,300,400,100italic,200italic,300italic,400italic,500italic,600italic,700italic' => 'Josefin Slab',
            'Jost:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Jost',
            ...
            'Kantumruy Pro:100,200,300,400,100italic,200italic,300italic,400italic,500italic,600italic,700italic' => 'Kantumruy Pro',
            'Karantina:300,400,700' => 'Karantina',
            'Karla:200,300,400,800,200italic,300italic,400italic,500italic,600italic,700italic,800italic' => 'Karla',
            'Karma:300,400' => 'Karma',
            'Katibeh:400' => 'Katibeh',
            ...
            'Kufam:400,800,900,400italic,500italic,600italic,700italic,800italic,900italic' => 'Kufam',
            ...
            'Kumbh Sans:100,200,300,400,800,900' => 'Kumbh Sans',
            'Kurale:400' => 'Kurale',
            ...
            'League Spartan:100,200,300,400,800,900' => 'League Spartan',
            'Leckerli One:400' => 'Leckerli One',
            'Ledger:400' => 'Ledger',
            'Lekton:400,400italic,700' => 'Lekton',
            'Lemon:400' => 'Lemon',
            'Lemonada:300,400' => 'Lemonada',
            'Lexend:100,200,300,400,800,900' => 'Lexend',
            'Lexend Deca:100,200,300,400,800,900' => 'Lexend Deca',
            'Lexend Exa:100,200,300,400,800,900' => 'Lexend Exa',
            'Lexend Giga:100,200,300,400,800,900' => 'Lexend Giga',
            'Lexend Mega:100,200,300,400,800,900' => 'Lexend Mega',
            'Lexend Peta:100,200,300,400,800,900' => 'Lexend Peta',
            'Lexend Tera:100,200,300,400,800,900' => 'Lexend Tera',
            'Lexend Zetta:100,200,300,400,800,900' => 'Lexend Zetta',
            ...
            'Libre Bodoni:400,400italic,500italic,600italic,700italic' => 'Libre Bodoni',
            'Libre Caslon Display:400' => 'Libre Caslon Display',
            'Libre Caslon Text:400,400italic,700' => 'Libre Caslon Text',
            'Libre Franklin:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Libre Franklin',
            ...
            'Literata:200,300,400,800,900,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Literata',
            ...
            'Lora:400,400italic,500italic,600italic,700italic' => 'Lora',
            ...
            'M PLUS 1:100,200,300,400,800,900' => 'M PLUS 1',
            'M PLUS 1 Code:100,200,300,400' => 'M PLUS 1 Code',
            'M PLUS 1p:100,300,400,500,700,800,900' => 'M PLUS 1p',
            'M PLUS 2:100,200,300,400,800,900' => 'M PLUS 2',
            'M PLUS Code Latin:100,200,300,400' => 'M PLUS Code Latin',
            ...
            'Mada:200,300,400,900' => 'Mada',
            'Magra:400,700' => 'Magra',
            'Maiden Orange:400' => 'Maiden Orange',
            'Maitree:200,300,400' => 'Maitree',
            ...
            'Manrope:200,300,400,800' => 'Manrope',
            'Mansalva:400' => 'Mansalva',
            'Manuale:300,400,800,300italic,400italic,500italic,600italic,700italic,800italic' => 'Manuale',
            'Marcellus:400' => 'Marcellus',
            'Marcellus SC:400' => 'Marcellus SC',
            'Marck Script:400' => 'Marck Script',
            'Margarine:400' => 'Margarine',
            'Markazi Text:400' => 'Markazi Text',
            ...
            'Mate SC:400' => 'Mate SC',
            'Maven Pro:400,800,900' => 'Maven Pro',
            'McLaren:400' => 'McLaren',
            ...
            'Merriweather Sans:300,400,800,300italic,400italic,500italic,600italic,700italic,800italic' => 'Merriweather Sans',
            'Metal:400' => 'Metal',
            ...
            'Montaga:400' => 'Montaga',
            'Montagu Slab:100,200,300,400' => 'Montagu Slab',
            'MonteCarlo:400' => 'MonteCarlo',
            'Montez:400' => 'Montez',
            'Montserrat:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Montserrat',
            ...
            'Ms Madi:400' => 'Ms Madi',
            'Mukta:200,300,400,800' => 'Mukta',
            'Mukta Mahee:200,300,400,800' => 'Mukta Mahee',
            'Mukta Malar:200,300,400,800' => 'Mukta Malar',
            'Mukta Vaani:200,300,400,800' => 'Mukta Vaani',
            'Mulish:200,300,400,800,900,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Mulish',
            'Murecho:100,200,300,400,800,900' => 'Murecho',
            'MuseoModerno:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'MuseoModerno',
            'My Soul:400' => 'My Soul',
            ...
            'Newsreader:200,300,400,800,200italic,300italic,400italic,500italic,600italic,700italic,800italic' => 'Newsreader',
            'Niconne:400' => 'Niconne',
            ...
            'Noto Emoji:300,400' => 'Noto Emoji',
            'Noto Kufi Arabic:100,200,300,400,800,900' => 'Noto Kufi Arabic',
            'Noto Music:400' => 'Noto Music',
            'Noto Naskh Arabic:400' => 'Noto Naskh Arabic',
            'Noto Nastaliq Urdu:400,700' => 'Noto Nastaliq Urdu',
            'Noto Rashi Hebrew:100,200,300,400,800,900' => 'Noto Rashi Hebrew',
            ...
            'Noto Sans Adlam:400' => 'Noto Sans Adlam',
            'Noto Sans Adlam Unjoined:400' => 'Noto Sans Adlam Unjoined',
            'Noto Sans Anatolian Hieroglyphs:400' => 'Noto Sans Anatolian Hieroglyphs',
            'Noto Sans Arabic:100,200,300,400,800,900' => 'Noto Sans Arabic',
            'Noto Sans Armenian:100,200,300,400,800,900' => 'Noto Sans Armenian',
            'Noto Sans Avestan:400' => 'Noto Sans Avestan',
            'Noto Sans Balinese:400' => 'Noto Sans Balinese',
            'Noto Sans Bamum:400' => 'Noto Sans Bamum',
            'Noto Sans Bassa Vah:400' => 'Noto Sans Bassa Vah',
            'Noto Sans Batak:400' => 'Noto Sans Batak',
            'Noto Sans Bengali:100,200,300,400,800,900' => 'Noto Sans Bengali',
            ...
            'Noto Sans Canadian Aboriginal:100,200,300,400,800,900' => 'Noto Sans Canadian Aboriginal',
            ...
            'Noto Sans Cham:100,200,300,400,800,900' => 'Noto Sans Cham',
            'Noto Sans Cherokee:100,200,300,400,800,900' => 'Noto Sans Cherokee',
            ...
            'Noto Sans Devanagari:100,200,300,400,800,900' => 'Noto Sans Devanagari',
            'Noto Sans Display:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Noto Sans Display',
            ...
            'Noto Sans Georgian:100,200,300,400,800,900' => 'Noto Sans Georgian',
            ...
            'Noto Sans Gujarati:100,200,300,400,800,900' => 'Noto Sans Gujarati',
            'Noto Sans Gunjala Gondi:400' => 'Noto Sans Gunjala Gondi',
            'Noto Sans Gurmukhi:100,200,300,400,800,900' => 'Noto Sans Gurmukhi',
            'Noto Sans HK:100,300,400,500,700,900' => 'Noto Sans HK',
            'Noto Sans Hanifi Rohingya:400' => 'Noto Sans Hanifi Rohingya',
            'Noto Sans Hanunoo:400' => 'Noto Sans Hanunoo',
            'Noto Sans Hatran:400' => 'Noto Sans Hatran',
            'Noto Sans Hebrew:100,200,300,400,800,900' => 'Noto Sans Hebrew',
            ...
            'Noto Sans Kannada:100,200,300,400,800,900' => 'Noto Sans Kannada',
            'Noto Sans Kayah Li:400' => 'Noto Sans Kayah Li',
            'Noto Sans Kharoshthi:400' => 'Noto Sans Kharoshthi',
            'Noto Sans Khmer:100,200,300,400,800,900' => 'Noto Sans Khmer',
            'Noto Sans Khojki:400' => 'Noto Sans Khojki',
            'Noto Sans Khudawadi:400' => 'Noto Sans Khudawadi',
            'Noto Sans Lao:100,200,300,400,800,900' => 'Noto Sans Lao',
            ...
            'Noto Sans Medefaidrin:400' => 'Noto Sans Medefaidrin',
            'Noto Sans Meetei Mayek:100,200,300,400,800,900' => 'Noto Sans Meetei Mayek',
            ...
            'Noto Sans Mono:100,200,300,400,800,900' => 'Noto Sans Mono',
            'Noto Sans Mro:400' => 'Noto Sans Mro',
            'Noto Sans Multani:400' => 'Noto Sans Multani',
            'Noto Sans Myanmar:100,200,300,400,800,900' => 'Noto Sans Myanmar',
            ...
            'Noto Sans Ol Chiki:400' => 'Noto Sans Ol Chiki',
            ...
            'Noto Sans Sinhala:100,200,300,400,800,900' => 'Noto Sans Sinhala',
            'Noto Sans Sogdian:400' => 'Noto Sans Sogdian',
            'Noto Sans Sora Sompeng:400' => 'Noto Sans Sora Sompeng',
            'Noto Sans Soyombo:400' => 'Noto Sans Soyombo',
            'Noto Sans Sundanese:400' => 'Noto Sans Sundanese',
            'Noto Sans Syloti Nagri:400' => 'Noto Sans Syloti Nagri',
            'Noto Sans Symbols:100,200,300,400,800,900' => 'Noto Sans Symbols',
            ...
            'Noto Sans Tai Tham:400' => 'Noto Sans Tai Tham',
            'Noto Sans Tai Viet:400' => 'Noto Sans Tai Viet',
            'Noto Sans Takri:400' => 'Noto Sans Takri',
            'Noto Sans Tamil:100,200,300,400,800,900' => 'Noto Sans Tamil',
            'Noto Sans Tamil Supplement:400' => 'Noto Sans Tamil Supplement',
            'Noto Sans Telugu:100,200,300,400,800,900' => 'Noto Sans Telugu',
            'Noto Sans Thaana:100,200,300,400,800,900' => 'Noto Sans Thaana',
            'Noto Sans Thai:100,200,300,400,800,900' => 'Noto Sans Thai',
            'Noto Sans Thai Looped:100,200,300,400,800,900' => 'Noto Sans Thai Looped',
            ...
            'Noto Serif Armenian:100,200,300,400,800,900' => 'Noto Serif Armenian',
            'Noto Serif Balinese:400' => 'Noto Serif Balinese',
            'Noto Serif Bengali:100,200,300,400,800,900' => 'Noto Serif Bengali',
            'Noto Serif Devanagari:100,200,300,400,800,900' => 'Noto Serif Devanagari',
            'Noto Serif Display:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Noto Serif Display',
            'Noto Serif Dogra:400' => 'Noto Serif Dogra',
            'Noto Serif Ethiopic:100,200,300,400,800,900' => 'Noto Serif Ethiopic',
            'Noto Serif Georgian:100,200,300,400,800,900' => 'Noto Serif Georgian',
            'Noto Serif Grantha:400' => 'Noto Serif Grantha',
            'Noto Serif Gujarati:100,200,300,400,800,900' => 'Noto Serif Gujarati',
            'Noto Serif Gurmukhi:100,200,300,400,800,900' => 'Noto Serif Gurmukhi',
            'Noto Serif HK:200,300,400,800,900' => 'Noto Serif HK',
            'Noto Serif Hebrew:100,200,300,400,800,900' => 'Noto Serif Hebrew',
            'Noto Serif JP:200,300,400,900' => 'Noto Serif JP',
            'Noto Serif KR:200,300,400,900' => 'Noto Serif KR',
            'Noto Serif Kannada:100,200,300,400,800,900' => 'Noto Serif Kannada',
            'Noto Serif Khmer:100,200,300,400,800,900' => 'Noto Serif Khmer',
            'Noto Serif Lao:100,200,300,400,800,900' => 'Noto Serif Lao',
            'Noto Serif Malayalam:100,200,300,400,800,900' => 'Noto Serif Malayalam',
            'Noto Serif Myanmar:100,200,300,400,800,900' => 'Noto Serif Myanmar',
            'Noto Serif Nyiakeng Puachue Hmong:400' => 'Noto Serif Nyiakeng Puachue Hmong',
            'Noto Serif SC:200,300,400,900' => 'Noto Serif SC',
            'Noto Serif Sinhala:100,200,300,400,800,900' => 'Noto Serif Sinhala',
            'Noto Serif TC:200,300,400,900' => 'Noto Serif TC',
            'Noto Serif Tamil:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Noto Serif Tamil',
            'Noto Serif Tangut:400' => 'Noto Serif Tangut',
            'Noto Serif Telugu:100,200,300,400,800,900' => 'Noto Serif Telugu',
            'Noto Serif Thai:100,200,300,400,800,900' => 'Noto Serif Thai',
            'Noto Serif Tibetan:100,200,300,400,800,900' => 'Noto Serif Tibetan',
            'Noto Serif Yezidi:400' => 'Noto Serif Yezidi',
            ...
            'Numans:400' => 'Numans',
            'Nunito:200,300,400,800,900,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Nunito',
            ...
            'Open Sans:300,400,800,300italic,400italic,500italic,600italic,700italic,800italic' => 'Open Sans',
            'Oranienbaum:400' => 'Oranienbaum',
            'Orbitron:400,800,900' => 'Orbitron',
            'Oregano:400,400italic' => 'Oregano',
            'Orelega One:400' => 'Orelega One',
            'Orienta:400' => 'Orienta',
            'Original Surfer:400' => 'Original Surfer',
            'Oswald:200,300,400' => 'Oswald',
            'Outfit:100,200,300,400,800,900' => 'Outfit',
            ...
            'Overpass:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Overpass',
            'Overpass Mono:300,400' => 'Overpass Mono',
            'Ovo:400' => 'Ovo',
            'Oxanium:200,300,400,800' => 'Oxanium',
            ...
            'Palanquin:100,200,300,400' => 'Palanquin',
            'Palanquin Dark:400' => 'Palanquin Dark',
            ...
            'Petrona:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Petrona',
            'Philosopher:400,400italic,700,700italic' => 'Philosopher',
            'Piazzolla:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Piazzolla',
            'Piedra:400' => 'Piedra',
            ...
            'Playfair Display:400,800,900,400italic,500italic,600italic,700italic,800italic,900italic' => 'Playfair Display',
            'Playfair Display SC:400,400italic,700,700italic,900,900italic' => 'Playfair Display SC',
            'Plus Jakarta Sans:200,300,400,800,200italic,300italic,400italic,500italic,600italic,700italic,800italic' => 'Plus Jakarta Sans',
            'Podkova:400,800' => 'Podkova',
            ...
            'Public Sans:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Public Sans',
            ...
            'Quicksand:300,400' => 'Quicksand',
            'Quintessential:400' => 'Quintessential',
            'Qwigley:400' => 'Qwigley',
            'Qwitcher Grypen:400,700' => 'Qwitcher Grypen',
            'Racing Sans One:400' => 'Racing Sans One',
            'Radio Canada:300,400,300italic,400italic,500italic,600italic,700italic' => 'Radio Canada',
            'Radley:400,400italic' => 'Radley',
            'Rajdhani:300,400' => 'Rajdhani',
            'Rakkas:400' => 'Rakkas',
            'Raleway:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Raleway',
            ...
            'Rancho:400' => 'Rancho',
            'Ranga:400,700' => 'Ranga',
            'Rasa:300,400,300italic,400italic,500italic,600italic,700italic' => 'Rasa',
            'Rationale:400' => 'Rationale',
            'Ravi Prakash:400' => 'Ravi Prakash',
            'Readex Pro:200,300,400' => 'Readex Pro',
            'Recursive:300,400,800,900' => 'Recursive',
            'Red Hat Display:300,400,800,900,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Red Hat Display',
            'Red Hat Mono:300,400,300italic,400italic,500italic,600italic,700italic' => 'Red Hat Mono',
            'Red Hat Text:300,400,300italic,400italic,500italic,600italic,700italic' => 'Red Hat Text',
            'Red Rose:300,400' => 'Red Rose',
            'Redacted:400' => 'Redacted',
            'Redacted Script:300,400,700' => 'Redacted Script',
            'Redressed:400' => 'Redressed',
            'Reem Kufi:400' => 'Reem Kufi',
            ...
            'Roboto Mono:100,200,300,400,100italic,200italic,300italic,400italic,500italic,600italic,700italic' => 'Roboto Mono',
            'Roboto Serif:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Roboto Serif',
            'Roboto Slab:100,200,300,400,800,900' => 'Roboto Slab',
            'Rochester:400' => 'Rochester',
            'Rock Salt:400' => 'Rock Salt',
            'RocknRoll One:400' => 'RocknRoll One',
            'Rokkitt:100,200,300,400,800,900' => 'Rokkitt',
            'Romanesco:400' => 'Romanesco',
            'Ropa Sans:400,400italic' => 'Ropa Sans',
            'Rosario:300,400,300italic,400italic,500italic,600italic,700italic' => 'Rosario',
            'Rosarivo:400,400italic' => 'Rosarivo',
            'Rouge Script:400' => 'Rouge Script',
            'Rowdies:300,400,700' => 'Rowdies',
            'Rozha One:400' => 'Rozha One',
            'Rubik:300,400,800,900,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Rubik',
            ...
            'Ruthie:400' => 'Ruthie',
            'Rye:400' => 'Rye',
            'STIX Two Text:400,400italic,500italic,600italic,700italic' => 'STIX Two Text',
            'Sacramento:400' => 'Sacramento',
            'Sahitya:400,700' => 'Sahitya',
            'Sail:400' => 'Sail',
            'Saira:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Saira',
            'Saira Condensed:100,200,300,400,800,900' => 'Saira Condensed',
            'Saira Extra Condensed:100,200,300,400,800,900' => 'Saira Extra Condensed',
            'Saira Semi Condensed:100,200,300,400,800,900' => 'Saira Semi Condensed',
            ...
            'Sansita Swashed:300,400,800,900' => 'Sansita Swashed',
            ...
            'Shippori Mincho:400,800' => 'Shippori Mincho',
            'Shippori Mincho B1:400,800' => 'Shippori Mincho B1',
            'Shojumaru:400' => 'Shojumaru',
            'Short Stack:400' => 'Short Stack',
            'Shrikhand:400' => 'Shrikhand',
            'Siemreap:400' => 'Siemreap',
            'Sigmar One:400' => 'Sigmar One',
            'Signika:300,400' => 'Signika',
            'Signika Negative:300,400' => 'Signika Negative',
            ...
            'Smokum:400' => 'Smokum',
            'Smooch:400' => 'Smooch',
            'Smooch Sans:100,200,300,400,800,900' => 'Smooch Sans',
            'Smythe:400' => 'Smythe',
            ...
            'Sora:100,200,300,400,800' => 'Sora',
            'Sorts Mill Goudy:400,400italic' => 'Sorts Mill Goudy',
            'Source Code Pro:200,300,400,800,900,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Source Code Pro',
            'Source Sans 3:200,300,400,800,900,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Source Sans 3',
            'Source Sans Pro:200,200italic,300,300italic,400,400italic,600,600italic,700,700italic,900,900italic' => 'Source Sans Pro',
            'Source Serif 4:200,300,400,800,900,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Source Serif 4',
            'Source Serif Pro:200,200italic,300,300italic,400,400italic,600,600italic,700,700italic,900,900italic' => 'Source Serif Pro',
            'Space Grotesk:300,400' => 'Space Grotesk',
            ...
            'Spirax:400' => 'Spirax',
            'Splash:400' => 'Splash',
            'Spline Sans:300,400' => 'Spline Sans',
            'Spline Sans Mono:300,400,300italic,400italic,500italic,600italic,700italic' => 'Spline Sans Mono',
            ...
            'Stick:400' => 'Stick',
            'Stick No Bills:200,300,400,800' => 'Stick No Bills',
            ...
            'Texturina:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Texturina',
            ...
            'Tourney:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Tourney',
            ...
            'Trispace:100,200,300,400,800' => 'Trispace',
            'Trocchi:400' => 'Trocchi',
            'Trochut:400,400italic,700' => 'Trochut',
            'Truculenta:100,200,300,400,800,900' => 'Truculenta',
            'Trykker:400' => 'Trykker',
            ...
            'Updock:400' => 'Updock',
            'Urbanist:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Urbanist',
            'VT323:400' => 'VT323',
            ...
            'Vazirmatn:100,200,300,400,800,900' => 'Vazirmatn',
            ...
            'Vollkorn:400,800,900,400italic,500italic,600italic,700italic,800italic,900italic' => 'Vollkorn',
            ...
            'Work Sans:100,200,300,400,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic' => 'Work Sans',
            'Xanh Mono:400,400italic' => 'Xanh Mono',
            'Yaldevi:200,300,400' => 'Yaldevi',
            'Yanone Kaffeesatz:200,300,400' => 'Yanone Kaffeesatz',
            ...
            'Yomogi:400' => 'Yomogi',
            'Yrsa:300,400,300italic,400italic,500italic,600italic,700italic' => 'Yrsa',
